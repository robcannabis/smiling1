...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/1176194821698879608/1244203979248893973/vavaxvw.gif?ex=666f4980&is=666df800&hm=b93d36a874b86da1332f16aef5234e52860032c8a3d792c1f24613845d7c2c80&']; //รูปใหญ่
    ...
    const yyyt = ['Join My Server ♡']; // ชื่อ button1
    const ddds = ['https://discord.gg/qPJt25MVEs']; // ลิ้ง button1

   const iooi = ['Smiling·˚ ༘']; // ชื่อ button 2
   const iiio = ['https://youtube.com/@smiling23?si=YGr3YSSafKuJgLBE']; // ลิ้ง button 2
...
change[Math.floor(Math.random()*change.length)]; // รูปใหญ่
    ...
    const r = new Discord.RichPresence()
      ...
      .setName(`RobShop`)
      .setDetails(`꒰ ติดต่อสอบถาม ꒱ Dm 24/7 ˎˊ˗`)
